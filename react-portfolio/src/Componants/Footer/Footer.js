    ...
    return (
        <footer>
            <div className="md:flex md:p-4 bg-base-200 gap-x-4 space-y-1 text-gray-500">
                <div className="sm:size-[50%] space-y-1">
                    <div className="collapse collapse-plus rounded-[3px] bg-base-200 shadow-md">
                        <input type="radio" name="my-accordion-3" checked="checked" />
                        <div className="collapse-title text-xl font-medium">Do you know how JACKET-POINT got its name?</div>
            ...
            <div className="footer bg-base-300 flex items-center justify-around p-4">
                <aside className="grid-flow-col items-center">
                    ...
                    <p>Copyright © {new Date().getFullYear()} - All right reserved <br />Developer (Maruf & Mehedi)</p>
                </aside>
                <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end text-sky-400">
                    <a>
